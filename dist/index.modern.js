...
var LabeledInput = React.forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(StyledLabeledInput, {
    className: className,
    fontSize: fontSize
...
var LoadingBackdrop = function LoadingBackdrop(_ref) {
  var text = _ref.text,
      color = _ref.color;
  return /*#__PURE__*/React.createElement(StyledLoadingBackdrop, null, /*#__PURE__*/React.createElement(SpinningCircle, {
    color: color
